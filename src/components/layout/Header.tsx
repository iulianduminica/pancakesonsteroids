...
const Header: React.FC<HeaderProps> = ({ status, workoutId, userName, switchProfile }) => {
      ...
      <div className="flex flex-col items-center sm:items-end">
        ...
        {workoutId && (
          <div className="mt-1 flex items-center gap-2 rounded-full bg-secondary px-3 py-1 text-xs">
            ...
            <Button variant="ghost" size="icon" className="h-6 w-6" onClick={switchProfile} title={t('Header.switchProfile')}>
